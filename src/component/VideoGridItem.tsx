...
const VideoGridItem = ({
  id, title, channel, views, postedAt, duration,
  ...
  return (
    <div className="flex flex-col gap-2"
      ...
      <a href={`/watch?v=${id}`} className="relative aspect-video">
        ...
        <video className={`block h-full object-cover absolute inset-0 translate-opacity duration-200 ${isVideoPlaying ? "opacity-100 delay-200" : "opacity-0"}`} ref={videoRef} muted playsInline src={videoUrl} />
      </a>
